        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card my-5"> <!--card-->
                ...
                <form class="form" action="" role="form" method="post">
                    ...
                    <div class="my-3">  <!--txtpassword-->
                    <input type="password" id="txtUserName" name="txtUserName" class="form-control" placeholder="Password">
                    </div> <!--end of txtpassword-->

                    <div class="my-3">  <!--button -->
                        <button class="btn btn-danger btn-block text-uppercase">Log in</button>
                    </div> <!-- end of button -->
